...
export class CustmerService {
  ...
  getAllCustomer(): Observable<Customer[]> {
    return this.httpClient.get<Customer[]>(this.url + '/user/customer' + '/findall');
    pipe(catchError(this.handleError));
  }

  deleteCustomer(customerId: number): Observable<Customer> {
    return this.httpClient
      .delete<Customer>(this.url + '/admin/customer/delete/' + customerId)
      .pipe(catchError(this.handleError));
  }
  ...
  getCustomerById(id: any): Observable<Customer> {
    return this.httpClient
      .get<Customer>(this.url + '/user/customer/view/' + id)
      .pipe(catchError(this.handleError));
  }
