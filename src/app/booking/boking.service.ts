...
export class BokingService {
  ...
  getAllBookings(): Observable<Booking[]> {
    return this.httpClient.get<Booking[]>(this.url + '/user/booking' + '/findall');
  ...
  getBookingById(id: any): Observable<Booking> {
    return this.httpClient
      .get<Booking>(this.url + '/user/booking/view/' + id)
      .pipe(catchError(this.handleError));
  }

  deleteBooking(bookingId: number): Observable<Booking> {
    return this.httpClient
      .delete<Booking>(this.url + '/user/booking/delete/' + bookingId)
      .pipe(catchError(this.handleError));
  }

  getTotalCost(id: any): Observable<Booking> {
    return this.httpClient
      .get<Booking>(this.url + '/user/booking/cost/' + id)
      .pipe(catchError(this.handleError));
  }
